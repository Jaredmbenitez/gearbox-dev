        ...
        <form onSubmit={handleSubmit} className="mx-4 my-4 p-4 border border-gray-300 rounded" >
            ...
            <div className="grid grid-cols-1">
                ...
                <div>
                    ...
                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Image URL (Ex. http://www.boxequalsart.com/wpimages/wp78273398_06.jpg)" onChange={(e) => setImageURL(e.target.value)} />
                </div>
